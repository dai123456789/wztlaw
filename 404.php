...
<head>
    ...
    <style>
        ...
        .agileits-content {
            ...
            float: left;
            width: 56%;
            background: url('./wp-content/themes/wztlaw/assets/images/banner.png') center no-repeat;
        ...
        .w3layouts-right {
            float: left;
            width: 44%;
            background: url(./wp-content/themes/wztlaw/assets/images/cut.jpg)no-repeat center;
            background-size: cover;
            min-height: 690px;
        }
