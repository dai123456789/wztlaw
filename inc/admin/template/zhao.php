...
<form class="layui-form" action="" submit="return false">
			...
			foreach($wztlaw_index['pic'] as $key=>$val){
				...
				echo '<div class="layui-collapse" lay-accordion="">
        			<div class="layui-colla-item">
        				<h2 class="layui-colla-title">招聘</h2>
        				<div class="layui-colla-content">
						
						    <div class="layui-form-item">
                                 <label class="layui-form-label">职位</label>
                        	     <div class="layui-input-block">
                        	      <input type="text" name="position'.$i.'"   autocomplete="off" placeholder="" class="layui-input" value="'.$val['position'].'" style="width:36%">
                        	     </div>
                        	</div>
                        	<div class="layui-form-item">
                                 <label class="layui-form-label">招聘要求</label>
                        	     <div class="layui-input-block">
                        	      <input type="text" name="desc'.$i.'"   autocomplete="off" placeholder="" class="layui-input" value="'.$val['desc'].'" style="width:36%">
                        	     </div>
                        	</div>
							<div class="layui-form-item">
	...
	<div class="layui-form-item lunbo_add" <?php if(isset($wztlaw_index['lunbo_open']) && ($wztlaw_index['lunbo_open']==1)){}else{echo 'style="display:none"';}?>>
	    <label class="layui-form-label"></label>
	  	<button type="button" class="layui-btn lunbo_add_hdp layui-btn-normal"><i class="layui-icon layui-icon-addition"></i>添加职位</button>
	  	<span style="color:red">提示：点击添加职位会新增一张职位添加窗口</span>
	</div>
	<div class="layui-form-item">
	    <div class="layui-input-block">
	    	<input type="hidden" name="wztlaw" value="17">
        			...
        			<div class="layui-colla-item">
        				...
        				<div class="layui-colla-content layui-show">
						    ...
						    <div class="layui-form-item">
                                 <label class="layui-form-label">职位</label>
                        	     <div class="layui-input-block">
                        	      <input type="text" name="position`+num+`"   autocomplete="off" placeholder="" class="layui-input" value="" style="width:36%">
                        	     </div>
                        	</div>
                        	<div class="layui-form-item">
                                 <label class="layui-form-label">招聘要求</label>
                        	     <div class="layui-input-block">
                        	      <input type="text" name="desc`+num+`"   autocomplete="off" placeholder="" class="layui-input" value="" style="width:36%">
                        	     </div>
                        	</div>
							<div class="layui-form-item">
							    <label class="layui-form-label"></label>
