...
<form class="layui-form" action="" submit="return false">
			...
			foreach($wztlaw_index['pic'] as $key=>$val){
				...
				echo '<div class="layui-collapse" lay-accordion="">
        			<div class="layui-colla-item">
        				<h2 class="layui-colla-title">幻灯片</h2>
        				<div class="layui-colla-content">
						    ...
						    <div class="layui-form-item">
						        ...
						        <div class="layui-upload">
						            <button type="button" class="layui-btn" id="mobile_test'.$i.'" onclick="mobile_test('.$i.')">上传图片</button>
						            <input type="hidden" name="mobile_test'.$i.'"  value="'.$val['mobile_test'].'">
						            <div class="layui-upload-list" style="border:1px dashed #ccc;width:200px;height:200px;overflow:hidden;margin-left:110px;line-height:200px">
						               <img class="layui-upload-img" id="mobile_demo'.$i.'" style="width:200px" src="'.$val['mobile_test'].'">
						    ...
						    <div class="layui-form-item">
                                 <label class="layui-form-label">alt描述</label>
                        	     <div class="layui-input-block">
                        	      <input type="text" name="mobile_alt'.$i.'"   autocomplete="off" placeholder="" class="layui-input" value="'.$val['mobile_alt'].'" style="width:36%">
                        	     </div>
                        	</div>
						    <div class="layui-form-item">
							...
							<div class="layui-form-item">
							    ...
							    <div class="layui-input-block" >';
							    	if($val['nofollow']){
							    		echo '<input type="checkbox" name="nofollow'.$i.'" lay-skin="switch" lay-text="开|关" checked>';
							    	}else{
							    		echo '<input type="checkbox" name="nofollow'.$i.'" lay-skin="switch" lay-text="开|关" >';
							    	}
							    echo '	
							    </div>
							  </div>
	...
	<div class="layui-form-item lunbo_add" <?php if(isset($wztlaw_index['lunbo_open']) && ($wztlaw_index['lunbo_open']==1)){}else{echo 'style="display:none"';}?>>
	    <label class="layui-form-label"></label>
	  	<button type="button" class="layui-btn lunbo_add_hdp layui-btn-normal"><i class="layui-icon layui-icon-addition"></i>添加幻灯片</button>
	  	<span style="color:red">提示：点击添加幻灯片会新增一张幻灯片添加窗口</span>
	</div>
	<div class="layui-form-item">
	    <div class="layui-input-block">
	    	<input type="hidden" name="wztlaw" value="3">
        			...
        			<div class="layui-colla-item">
        				...
        				<div class="layui-colla-content layui-show">
						    ...
						    <div class="layui-form-item">
						        <label class="layui-form-label">手机端</label>
						        <div class="layui-upload">
						            <button type="button" class="layui-btn" id="mobile_test`+num+`" onclick="mobile_test(`+num+`)">上传图片</button>
						            <input type="hidden" name="mobile_test`+num+`" >
						            <div class="layui-upload-list" style="border:1px dashed #ccc;width:200px;height:200px;overflow:hidden;margin-left:110px;line-height:200px">
						               <img class="layui-upload-img" id="mobile_demo`+num+`" style="width:200px">
						    ...
						    <div class="layui-form-item">
                                 <label class="layui-form-label">alt描述</label>
                        	     <div class="layui-input-block">
                        	      <input type="text" name="mobile_alt`+num+`"   autocomplete="off" placeholder="" class="layui-input" value="" style="width:36%">
                        	     </div>
                        	</div>
						    <div class="layui-form-item">
						         <label class="layui-form-label">跳转链接</label>
